...
parser.add_argument("--kmeans_model",default= "rand_alexnet.10.n.kmeans.150.model")
parser.add_argument("--surf_path",default="alexnet_all")
parser.add_argument("--cluster_num", type=int,default=150)
parser.add_argument("--file_list",default= "videos.name.lst")
parser.add_argument("--output_path",default="alexnet_150Kmeans/")
